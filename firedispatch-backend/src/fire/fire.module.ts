...
import { FireLevelRequirementController } from './fire-level-requirement.controller';

@Module({
  imports: [UserModule, PrismaModule],
  controllers: [FireController, FireLevelController, FireLevelRequirementController],
